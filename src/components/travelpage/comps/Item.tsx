  ...
  return (
    <li className="mx-1">
      <div className="flex flex-row justify-between border-2 rounded-md border-solid border-violet-500 bg-violet-500 max-w-56 max-h-24 items-center px-1 py-4">
        ...
        <p className={`mx-1 py-2 `}>{item.quantity}#</p>
        <div className={`${item.packed ? "line-through" : ""} text-left overflow-x-scroll overflow-y-scroll my-2 py-2`}>
          <p className={`mx-1 py-2 uppercase max-h-20 min-w-20 `}>{item.description}</p>
        </div>
